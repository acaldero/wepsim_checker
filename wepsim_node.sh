#!/usr/bin/env node
   ...
   if (2 == process.argv.length)
   {
       ...
       console.log('   ./wepsim_node.sh run                   ep ./examples/microcode_3.txt ./examples/code_3.txt') ;
       console.log('') ;
       console.log(' * Run some example and show the state on each assembly instruction executed:') ;
       console.log('   ./wepsim_node.sh stepbystep            ep ./examples/microcode_3.txt ./examples/code_3.txt') ;
       console.log('') ;
       console.log(' * Run some example and show the state on each microinstruction executed:') ;
       console.log('   ./wepsim_node.sh microstepbymicrostep  ep ./examples/microcode_3.txt ./examples/code_3.txt') ;
       console.log('') ;
       console.log(' * Check that some example actually works:') ;
       console.log('   ./wepsim_node.sh check                 ep ./examples/microcode_3.txt ./examples/code_3.txt ./examples/checklist_3.txt') ;
       console.log('') ;
       console.log(' * Check that some example actually does not works:') ;
       console.log('   ./wepsim_node.sh check                 ep ./examples/microcode_3.txt ./examples/code_3.txt ./examples/checklist_2.txt') ;
       console.log('') ;
